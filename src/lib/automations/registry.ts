...
const NOT_YET_AVAILABLE = new Set<string>([
  "appointment_booked",
...
export function automationCapabilityCanPublish(type: AutomationTriggerType | AutomationActionType): boolean {
  return automationCapability(type) === "available";
}
...
export const TRIGGER_REGISTRY: readonly RegistryItem<AutomationTriggerType>[] = [
  ...
  { type: "bizad_viewed", label: "Business card viewed", category: "Business card", phase: "foundation", execution: "server" },
  { type: "bizad_action_clicked", label: "Business card action clicked", category: "Business card", phase: "foundation", execution: "server" },
...
export const ACTION_REGISTRY: readonly RegistryItem<AutomationActionType>[] = [
  ...
  { type: "save_lead", label: "Save lead", category: "Lead", phase: "foundation", execution: "server" },
  { type: "create_lead", label: "Create lead", category: "Lead", phase: "foundation", execution: "server" },
