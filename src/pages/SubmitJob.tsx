...
export default function SubmitJob() {
  ...
  return (
    <CustomerPortalShell maxWidth="3xl">
      <h1 className="font-display text-3xl font-bold md:text-4xl">Submit a project</h1>
      ...
      <div className="mt-8 space-y-8">
        ...
        <Button size="lg" onClick={submit} disabled={submitting} className="w-full shadow-glow">
          {submitting ? <><Loader2 className="mr-2 h-4 w-4 animate-spin" />Submitting...</> : "Submit project"}
        </Button>
      </div>
    </CustomerPortalShell>
  );
