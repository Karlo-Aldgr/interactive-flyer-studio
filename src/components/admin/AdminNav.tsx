...
export type AdminNavKey = "users" | "jobs" | "editors" | "analytics" | "contacts" | "examples" | "mini-ads" | "realtor-applications" | "realtor-portal";
...
const NAV_GROUPS: { label: string; keys: AdminNavKey[] }[] = [
  { label: "Operations", keys: ["editors", "contacts"] },
